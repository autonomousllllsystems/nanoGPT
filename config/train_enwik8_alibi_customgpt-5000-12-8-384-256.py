...
min_lr = 1e-5 # 1e-4 # learning_rate / 10 usually
...
out_dir =        f'out-enwik8-baseline-customgpt-alibi-{max_iters}-{n_layer}-{n_head}-{n_embd}-{block_size}-{dropout}'
wandb_run_name = f'enwik8-baseline-customgpt-alibi-{max_iters}-{n_layer}-{n_head}-{n_embd}-{block_size}-{dropout}'